...
FuzzyFinder.keys = {
    ...
    {'n', '<leader>fg', require('telescope.builtin').live_grep, { desc = "Live Grep"}},
    {'n', '<leader>fb', require('telescope.builtin').buffers, {desc = "Search buffers"}},
    {'n', '<leader>fh', require('telescope.builtin').help_tags, {desc = "Help tags"}},
    {'n', '<leader>ft', require('telescope.builtin').git_files, { desc = "Search Git Files"}},
